...
# -*- coding: utf-8 -*-
"""
Created on Sat May 26 22:03:33 2018
...
#ANN model to predict if the customer with the following informations will leave the bank: 
...
new_precition = (new_prediction>0.5)

# ans=false,the customer won't leave the bank
